...
import com.example.abcplusd.igram.adapter.UserProfileAdapter;
import com.example.abcplusd.igram.utils.CircleTransformation;
import com.example.abcplusd.igram.views.RevealBackgroudView;
import com.squareup.picasso.Picasso;

import butterknife.BindView;

public class UserProfileActivity extends BaseDrawerActivity implements RevealBackgroudView.OnStateChangeListener {
    ...
    RevealBackgroudView vRevealBackground;
...
//        vRevealBackground = (RevealBackgroudView)findViewById(R.id.vRevealBackground);
...
//        vUserProfileRoot = (View)findViewById(R.id.vUserProfileRoot);
    ...
    public void onStateChange(int state) {
        if (RevealBackgroudView.STATE_FINISHED == state) {
