...
import com.example.abcplusd.igram.activity.MainActivity;
import com.example.abcplusd.igram.views.LoadingFeedItemView;
...
//            }
//        });
        final HashMap<List<FeedItem>, Boolean> map = new HashMap<List<FeedItem>, Boolean>();
        map.put(feedItems, true);
        if(cellFeedViewHolder.ivFeedCenter.isPressed()){
            cellFeedViewHolder.ivFeedCenter.setOnClickListener(new View.OnClickListener() {
    ...
    public static class CellFeedViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bindView(FeedItem feedItem) {
            ...
            ivFeedCenter.setImageResource(adapterPosition % 2 == 0 ? R.drawable.varanasi : R.drawable.taj);
