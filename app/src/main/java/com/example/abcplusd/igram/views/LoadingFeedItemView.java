...
public class LoadingFeedItemView extends FrameLayout { @BindView(R.id.vSendingProgress)
ProgressBar vSendingProgress;
...
//        vSendingProgress.setOnLoadingFinishedListener(new ProgressBar(vSendingProgress).OnLoadingFinishedListener() {
//            @Override
