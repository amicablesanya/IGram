...
public class SendCommentButton  extends ViewAnimator implements View.OnClickListener {
    ...
    public void setCurrentState(int state) {
        ...
        if (state == STATE_DONE) {
            ...
            setInAnimation(getContext(), R.anim.slide_in_like_counter); //
            setOutAnimation(getContext(), R.anim.slide_in_like_counter);//
        } else if (state == STATE_SEND) {
            setEnabled(true);
            setInAnimation(getContext(), R.anim.slide_in_like_counter); //slide in send should be here
            setOutAnimation(getContext(), R.anim.slide_in_like_counter);//
        }
        showNext();
    }
