...
import com.example.abcplusd.igram.adapter.PhotoFilterAdapter;
...
public class TakePhotoActivity extends BaseActivity implements RevealBackgroudView.OnStateChangeListener{
...
//    }
        ...
        private void setupPhotoFilters() {
            ...
            rvFilters.setAdapter(photoFilterAdapter);
